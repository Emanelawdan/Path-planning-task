...
"21": (
    [
        # slight x stagger causes the nearest-in-x to change as s grows
        Cone(x=2.2, y=1.5, color=1),
        Cone(x=2.7, y=2.5, color=1),
        Cone(x=3.2, y=3.5, color=1),
    ],
    CarPose(x=0.0, y=0.0, yaw=0.0),
),
...
"22": (
    [
        # slight x stagger on rights; late left stays the same
        Cone(x=3.0, y=1.0, color=0),
        Cone(x=3.6, y=2.0, color=0),
        Cone(x=4.2, y=3.0, color=0),
